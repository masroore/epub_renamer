...
def _discover_toc(zf, opf_xmldoc, opf_filepath) -> Dict:
    '''
...
def get_epub_metadata(filepath: str, read_cover_image: bool = False, read_toc: bool = False) -> Dict:
    '''
...
def get_epub_opf_xml(filepath: str) -> bytes:
    '''
...
def process_file(fname: str, dirpath: str):
    ...
    title = sanitize_title(meta.get('title'))
